...
const HeroSection = () => {
  return <div className="bg-white relative z-10 py-[16px]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Spinning Coin GIF */}
        <div className="mb-12 py-0 my-[50px]">
          <img src="/lovable-uploads/IMG_1568.gif" alt="Spinning Buckazoids Coin" className="mx-auto w-32 h-32 sm:w-40 sm:h-40 animate-float" />
        </div>
