...
const AboutSection = () => {
  return (
    <section className="bg-buckazoid-dark text-white py-24" id="intro">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
          <div className="bg-buckazoid-navy p-8 rounded-lg shadow-xl">
            <div className="bg-buckazoid-blue/20 w-16 h-16 rounded-full flex items-center justify-center mb-6">
              <History className="text-buckazoid-yellow w-8 h-8" />
            </div>
            <h3 className="text-2xl font-bold text-buckazoid-yellow mb-4">A Digital Currency From 1989</h3>
            ...
            <Button variant="outline" className="border-buckazoid-yellow text-buckazoid-yellow hover:bg-buckazoid-yellow hover:text-buckazoid-dark">
          ...
          <div className="bg-buckazoid-navy p-8 rounded-lg shadow-xl">
            ...
            <Button variant="outline" className="border-buckazoid-orange text-buckazoid-orange hover:bg-buckazoid-orange hover:text-buckazoid-dark">
